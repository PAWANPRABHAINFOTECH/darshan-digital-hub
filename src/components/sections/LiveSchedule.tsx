...
import { liveConfig, upcomingPrograms } from "@/config/site";
...
export function LiveSchedule() {
  ...
  const rows = [
    {
      id: "now",
      name: liveConfig.programName,
      type: t("live.program"),
      date: liveConfig.date,
      time: liveConfig.time,
      venue: liveConfig.venue,
                ...
                <div>
                  ...
                  <ul className="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-sm text-muted-foreground">
                    <li className="inline-flex items-center gap-1.5">
                      <CalendarDays className="size-4" aria-hidden /> {r.date}
                    </li>
                    <li className="inline-flex items-center gap-1.5">
                      <Clock className="size-4" aria-hidden /> {r.time}
                    </li>
                    <li className="inline-flex items-center gap-1.5">
